    ...
    <div className="App modern-app">
      <header className="modern-header">
        <div className="header-content">
          {/* <img src="/full-moon.png" alt="Logo" className="app-logo" /> */}
          <h1 className="app-title">Right-To-Music</h1>
        </div>
        <span className="song-count-badge">
          <AnimatedNumber includeComma={true} animateToNumber={totalSongs} /> Songs
        </span>
      </header>
      <section className="listen-section card-section">
        <Listen
      ...
      {!isPhone && (
        <div className="audio-input modern-audio-input card-section">
          <div
          ...
          >
            <LiaLaptopSolid style={{ height: 24, width: 24 }} />
          </div>
          <div
          ...
          >
            <FaMicrophoneLines style={{ height: 24, width: 24 }} />
          </div>
        </div>
      )}
      ...
      <footer className="modern-footer">
        <span>Right-To-Music &copy; {new Date().getFullYear()}</span>
      </footer>
      <ToastContainer
        position="top-center"
        autoClose={5000}
